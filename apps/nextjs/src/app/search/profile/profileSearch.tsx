...
import { ProfileList } from "~/app/_components/helpers/forms/profile/profileList";
...
export default function ProfileSearch() {
  const [continuePoint, setContinuePoint] = React.useState<number>(0);
  ...
  const QueryResults = api.profile.naturalSearch.useQuery(
    {
      continuePoint,
      query,
      tags,
            ...
            <div className="grid gap-6 md:gap-8">
              ...
              <div className="grid gap-6">
                {!QueryResults.data ? (
                  ...
                  <ProfileList profiles={QueryResults.data} />
                )}
              </div>
            </div>
            <ContinueIterator
